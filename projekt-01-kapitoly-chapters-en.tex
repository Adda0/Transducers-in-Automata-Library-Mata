...
Table~\ref{tab:} shows comparison of performance of \mata and \mona on projection operation.
...
Overall, the design and implementation of \nfts in \mata is feasible, functional, should perform sufficiently enough, and is widely usable, with ready-for-use support for solving SMT formulae with string replace operations in \noodler.
