...
\noodler utilizes \mata to intuitively encode regular constraints as finite automata, allowing for solving the SMT formula satisfiability by performing standard automata operations on finite automata representing regular languages of string variables in the formula and corresponding constraints.
...
\paragraph{Words or Identity Insertion.}
