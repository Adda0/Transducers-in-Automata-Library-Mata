...
Numerous libraries aim to serve as a general-purpose automata libraries (e.g., ~\cite{automatanet, tacas24_mata_10.1007/978-3-031-57249-4_7,fado}) while others closely specialize on just specific use cases for which the libraries highly optimize (e.g., ~\cite{mona,automatajar}).
...
The basis of the performance of \mata is its three-level data structure called \deltastruct representing a transition relation of an automaton.
...
In these papers, \mata performs well, and outperforms even the state-of-the-art automata libraries described in Section~\cite{sec:other_automata_libraries}.
