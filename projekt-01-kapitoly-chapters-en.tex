...
For example, automata library \automatapy~\cite{automatapy} is an automata library with a support for \nfas and \dfas.
...
Henceforth, \mata is a clear choice for our intend to add support for generally usable finite transducers, which are performant enough to be applicable in string solving in \noodler.
