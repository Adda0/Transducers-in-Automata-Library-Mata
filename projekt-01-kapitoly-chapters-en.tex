...
To name another independent string solver, a well known string solver is \ostrich~\cite{AnthonyComplex2019} and others.
...
XSS and code injection can be performed when working with user-submitted data without proper sanitization.
...
Recent advances in analysis of programs manipulating strings, string solving, and automatic solving of string constraints over string languages have heightened the importance of modelling string replacement operations.
...
\noodler, as opposed to many other state-of-the-art SMT string solvers
(with the exception of \ostrich)
is based on automata techniques, utilizing finite automata to intuitively encode regular constraints.
...
% is used in analysis of string manipulating programs where it
