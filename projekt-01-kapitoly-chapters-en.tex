...
TODO
- associative operation for string solving with different patterns, denote $\composePipe$ and $\compose{x}{y}$.
- insert additional levels for balanced nfts on both sides
- insert self-loops
