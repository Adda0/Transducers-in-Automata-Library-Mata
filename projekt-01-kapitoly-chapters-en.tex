...
Finite transducers have interesting uses, e.g., as translators in natural language processing research and applications for phonological and morphological analysis, input parsers, machines to perform browser transductions and user input sanitization and more.
...
In doing so, we maintain the distinctive features of \mata: being fast, and easy to extend or modify.
